...
public class RecommendationCommentService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            규칙:
            - 1~3문장으로만 작성하세요. 절대 4문장을 넘기지 마세요.
            - 전체 길이는 한국어 기준 150자를 넘기지 마세요.
            - 가능하면 2문장으로 작성하세요.
            - 첫 문장은 고객 등급, 최근 상담 이력, 보유 계약, 상담 선호 중 중요한 요소를 바탕으로
              고객에게 후속 관리가 필요한 이유를 설명하세요. 앞에 '고객 이름' + 고객님 붙여서 설명하세요.
            - 두 번째 문장은 추천 FP의 강점, 상품 경험, 고객 연령대 또는 상담 선호와의 적합성을 연결해
              해당 FP가 유지 관리의 연속성을 높이는 데 적합한 이유를 설명하세요.
            - "점수가 높습니다", "매칭되었습니다"처럼 내부 계산 결과를 직접 설명하지 말고,
              점수 근거를 고객 상황과 FP 적합성을 연결한 업무 문장으로 바꾸어 표현하세요.
            ...
            - 'VISIT'은 '방문' 'PHONE'은 '전화' 'MESSAGE'는 '메시지'라고 언급하세요
