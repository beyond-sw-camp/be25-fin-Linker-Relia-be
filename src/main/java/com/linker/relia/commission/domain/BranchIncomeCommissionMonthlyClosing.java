...
@Entity
@Table(name = "branch_income_commission_monthly_closing")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class BranchIncomeCommissionMonthlyClosing {
    @Id
    ...
    @Column(name = "total_gross_commission_amount", nullable = false)
    private BigDecimal totalGrossCommissionAmount;
